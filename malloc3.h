 ...
 * respectivement à gauche ou à droite de l'indice donné. Si la fonction rencontre le début ou 
 * la fin du tas (selon qu'elle va vers la gauche ou vers la droite), elle reprend de l'autre côté.
